    ...
    <header className="bg-blue-900 text-white shadow-lg sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-8 font-medium items-center">
          ...
          <Link to="/register-leader" className="hover:text-cyan-300">
            Register
          </Link>

          <Link to="/check-status" className="hover:text-cyan-300">
            Check Status
          </Link>

          <Link to="/admin-login" className="hover:text-cyan-300">
            Admin
          </Link>
